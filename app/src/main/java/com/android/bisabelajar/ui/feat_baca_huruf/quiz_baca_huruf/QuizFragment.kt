...
import com.android.bisabelajar.data.model.getTwoRandomAbjadKapital
import com.android.bisabelajar.data.model.getTwoRandomAbjadNonKapital
import com.android.bisabelajar.databinding.FragmentQuizBinding
...
class QuizFragment : Fragment() {
    ...
    private val wrongAnswerNonKapital: List<String> = getTwoRandomAbjadNonKapital(listOf(abjad?.abjadNonKapital ?: "-"))
    private var correctAnswerNonKapital: List<String>  = listOf()
    private var wrongAndCorrectAnswerNonKapital : List<String>  = listOf()

    private val wrongAnswerKapital: List<String> = getTwoRandomAbjadKapital(listOf(abjad?.abjadKapital ?: "-"))
...
//                tv.textSize = 200f
    ...
    fun reset(isKapital: Boolean) {
        binding.quiz.apply {
            ...
            txtOpt1.text = if (isKapital) wrongAnswerKapital[0] else wrongAndCorrectAnswerNonKapital[0]
            txtOpt2.text = if (isKapital) wrongAnswerKapital[1] else wrongAndCorrectAnswerNonKapital[1]
            txtOpt3.text = if (isKapital) wrongAnswerKapital[2] else wrongAndCorrectAnswerNonKapital[2]
            txtOpt1.setTag(null)
            txtOpt2.setTag(null)
            txtOpt3.setTag(null)
