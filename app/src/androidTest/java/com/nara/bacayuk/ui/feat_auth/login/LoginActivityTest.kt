...
class LoginActivityTest{
    ...
    @get:Rule
    var activityRule: ActivityScenarioRule<com.nara.bacayuk.ui.feat_auth.login.LoginActivity> = ActivityScenarioRule(
        com.nara.bacayuk.ui.feat_auth.login.LoginActivity::class.java)
